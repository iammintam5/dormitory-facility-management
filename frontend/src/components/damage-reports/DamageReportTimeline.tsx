        ...
        <div key={log.id} className="flex gap-4">
          ...
          <div className="flex-1 rounded-2xl border border-slate-200 bg-slate-50 p-4">
            <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
              <div>
                <p className="text-sm font-semibold uppercase tracking-[0.16em] text-slate-500">{log.action}</p>
            ...
            <p className="mt-3 text-sm text-slate-700">{log.note || 'Không có ghi chú bổ sung.'}</p>
